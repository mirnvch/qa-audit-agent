...
export const COURSE_MODULES: Module[] = [
  {
    ...
    lessons: [
      ...
      lesson('01-architecture-basics', '1.2', 'sloi-svyazannost-svyaznost', 'Слои, связанность, связность',   45, 'draft'),
      lesson('01-architecture-basics', '1.3', 'arkhitektura-v-qa-proekte',  'Архитектура в QA-проекте',       45, 'draft'),
    ],
  },
  {
    id: '02-meet-nexus',
    ...
    icon: 'Compass',
    lessons: [
      lesson('02-meet-nexus', '2.1', 'chto-my-testiruem',     'Что мы тестируем — TMS, доменная модель', 40, 'draft'),
      lesson('02-meet-nexus', '2.2', 'vidy-testov-i-piramida','Виды тестов и пирамида',                  40, 'draft'),
    ],
  },
  {
    id: '03-stack',
